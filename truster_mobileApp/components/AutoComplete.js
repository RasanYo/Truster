...
const AutoComplete = ({
    ...
    const handleSelect = async value => {
        ...
        if (!neccessaryDetails.every(necessity => givenInputs.includes(necessity))) {
            console.log(`You need to give at least the following information: ${neccessaryDetails.join(', ')}`)
            return false
        }
        ...
        <View className="autocomplete">
            ...
            >
                {({getInputProps, suggestions, getSuggestionItemProps, loading}) => (
                    <View>
                        <TextInput {...getInputProps(inputProps)} />
                        ...
                        <View className={className}>
                            {suggestions.map((suggestion, index) => {
                                ...
                                return (
                                    <View {...getSuggestionItemProps(suggestion, { style })} key={index}>
