    ...
    return ( 
        <div className="new-post-preview">
            ...
            <form >
                ...
                {<AutoComplete setStreet={setStreet} setCity={setCity} setNpa={setNpa} setCountry={setCountry} setFullAdress={setFullAdress}/>}
                ...
                <select name="country" onChange={(e) => setCountry(e.target.value)} value>
