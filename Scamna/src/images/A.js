const A = () => {
    return ( 
        <svg width="36px" height="36px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"  ariaHidden="true" role="img" class="iconify iconify--twemoji" preserveAspectRatio="xMidYMid meet">
